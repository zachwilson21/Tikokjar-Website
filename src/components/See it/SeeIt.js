          ...
          return(
              <div className='see-it'>
                  <div className='see-it-section'>
                      ...
                      <div><img src={discord} alt='discord logo' className='images'/></div>
                  </div>
                  <div className='see-it-section'>
                      <div><img src={calender} alt='calender'className='images'/></div>
                      <div className='text'>
                  ...
                  <div className='see-it-section'>
                      ...
                      <div><img src={pencil} alt='notepad 'className='images'/></div>
                  </div>
                  <div className='see-it-section'>
                      <div><img src={fireworks} alt='fireworks 'className='images'/></div>
                      <div className='text'>
